...
function Skills() {
  ...
  return (
    ...
    <div className='flex justify-between'>
            ...
            <Button variant="outline" onClick={AddNewSkills} className="text-purple-500"> + Add More Skill</Button>
            <Button variant="outline" onClick={RemoveSkills} className="text-purple-500"> - Remove</Button>
